...
- The Accelerator has now generated the code.  You may see a pop up in the bottom right hand corner of the IDE asking if you want to open the project in a new tab.  If you do you can close that pop up and continue on to the next step.  If you clicked OK to the pop up and a new tab opened, you may close the new tab.  
